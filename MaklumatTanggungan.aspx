<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaklumatTanggungan.aspx.cs" Inherits="Permohonan_Perumahan_Rakyat_Selangor.MaklumatTanggungan" %>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-sm-12 col-xs-12">
                                ...
                                <div>
                                    ...
                                    <a class="btn btn-primary" href="#">Maklumat Tanggungan</a>
                                ...
                                <div class="widget-body">
                                    <div class="form-horizontal">
                                        ...
                                        <asp:Table ID="tanggungan" CssClass="table table-bordered table-hover" runat="server">
                                            <asp:TableHeaderRow>
                                                <asp:TableHeaderCell>Nama Ahli Keluarga / Tanggungan</asp:TableHeaderCell>
                                                <asp:TableHeaderCell>Hubungan</asp:TableHeaderCell>
                                                <asp:TableHeaderCell>Tarikh Lahir</asp:TableHeaderCell>
                                                <asp:TableHeaderCell>No. Surat Beranak / KP</asp:TableHeaderCell>
                                                <asp:TableHeaderCell>Jantina</asp:TableHeaderCell>
                                                <asp:TableHeaderCell>Pendapatan (RM)</asp:TableHeaderCell>
                                            </asp:TableHeaderRow>
                                            <asp:TableRow>
                                                <asp:TableCell>
                                                    <asp:TextBox ID="namaAhli" CssClass="form-control" runat="server" Text=""></asp:TextBox>
                                                </asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox ID="hubungan" CssClass="form-control" runat="server" Text=""></asp:TextBox>
                                                </asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox ID="dobKeluarga" CssClass="form-control" TextMode="Date" runat="server" Text=""></asp:TextBox>
                                                </asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox ID="icKeluarga" CssClass="form-control" runat="server" Text=""></asp:TextBox>
                                                </asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox ID="jantinaKeluarga" CssClass="form-control" runat="server" Text=""></asp:TextBox>
                                                </asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox ID="pendapatanKeluarga" CssClass="form-control" TextMode="Number" runat="server" Text="0.00"></asp:TextBox>
                                                </asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                        &nbsp;
                                            <div class="form-group">
                                                <div class="col-lg-8 col-lg-4">
                                                    <asp:Button ID="SimpanTanggungan" OnClick="SimpanTanggungan_Click" CssClass="btn btn-danger" Text="Simpan" runat="server" CausesValidation="false" />
                                                </div>
                                            </div>
                                        <div class="form-group">
                                            <asp:GridView ID="viewFamily" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped" Font-Names="Century Gothic" Font-Size="10pt" ShowHeaderWhenEmpty="True" HorizontalAlign="Right">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:LinkButton Text="DELETE" ID="lnkDelete" CommandArgument='<%# Eval("IC_Ahli") %>' OnClick="lnkDelete_Click" runat="server" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
